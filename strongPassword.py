# A solution in Python someone else did
# https://www.hackerrank.com/rest/contests/master/challenges/strong-password/hackers/arknave/download_solution?primary=true
