...
describe('Vehicle Class', () => {
  ...
  it('should have a function `getSpec` on its prototype', () => {
    expect(vehicle.hasOwnProperty('getSpec')).toBe(false);
    expect(Vehicle.prototype.hasOwnProperty('getSpec')).toBe(true);
  });

  it('`getSpec` accepts a key as an argument and returns the value associated with that key from the object instance', () => {
